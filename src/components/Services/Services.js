	...
	return (
		<div className={"card " + cardData.class}>
			...
			<div className="logo-wrapper">
				<img className="card-logo" title={cardData.title} alt="" src={cardData.image.href} />
			</div>
			...
			<div className="description">
				...
				<ul>
					{cardData.subservices[props.lang].map(subservice => <li key={subservice}>{subservice}</li>)}
				</ul>
			...
			<div className="technologies">
				...
				{cardData.technologies.map(technology =>
					<div key={technology.title} className="technology">
						<img src={technology.logo} title={technology.title} alt={technology.title} />
					</div>
				)}
	...
	return (
		<section id="services" className="services">
			<div className="container">
				...
				<Fade className="services-grid" direction="top" cascade damping=".7" duration="700">

					{services.map(
						item => <div key={item.title[props.lang]} className="card-wrapper">
