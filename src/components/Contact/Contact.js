        ...
        <div className="contact-grid">
            ...
            <div className="contact-infos">
              ...
              <div
                dangerouslySetInnerHTML={{
                  __html: contact_text.intro[props.lang],
                }}
              />
            </div>
          </div>
          ...
          <div className="column">
            <form
              ...
              action="https://getform.io/f/bf1d35b9-9fd4-4df3-9b1b-8388c1da1200"
              method="POST"
            >
              <Pulse triggerOnce>
              ...
              <label htmlFor="tel-mail">
                {contact_form.form.contact[props.lang]}
              </label>
              <input
                type="text"
                name="tel-mail"
                placeholder={contact_form.form.contact[props.lang]}
                required
              />
              ...
              <input
                type="text"
                name="name"
                placeholder={contact_form.form.name[props.lang]}
                required
              />

              <label htmlFor="project">
                {contact_form.form.subject.name[props.lang]}
              </label>
              <textarea
                name="project"
                placeholder={contact_form.form.subject.placeholder[props.lang]}
              />

              <div className="GPDR">
                <input name="GPDR" type="checkbox" required />
                <label className="visible" htmlFor="GPDR">
                  {contact_form.form.GPDR.value[props.lang]}
                </label>
              </div>
