...
class TechnologiesDropdown extends React.Component {
    ...
    render() {
        ...
        return (<div className="dropdown-wrapper">
            ...
            <div id="dropdownTechnologies" className={"dropdown-content  " + (this.state.open ? "show" : "")}>
                <ul>
                    {this.props.context.technologies.map((item, i) => <li key={i}><strong>{item.category[this.props.lang]}</strong>{item.technology}</li>)}
                </ul>
            </div>
        </div>
        ...
        <section id="technologies" className="technologies">
            <div className="container">
                ...
                <Fade className="technologies-grid" direction="top" cascade>
                    ...
                    {primary_technologies.technologies.map(item => <div key={item.title} className="card"><TechnologyCard lang={props.lang} content={item} /></div>)}

                </Fade>

                <TechnologiesDropdown lang={props.lang} context={secondary_technologies} />
